...
Exécution du Pipeline
    ...
    Exécutez les cellules dans l'ordre :
        ...
        Configuration et création dossiers

        Ingestion Bronze (Amazon Reviews + Beauty Ratings)

        Transformation Silver (nettoyage)

        Enrichissement multi-sources (jointure + 2 features)

        Création Gold Layer (3 outputs)

        Contrôles qualité (4+ checks)
...
🎓 REMERCIEMENTS
    ...
    IPS : Institut Polytechnique de Saint-Louis pour les ressources
